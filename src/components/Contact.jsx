...
//                         <div className="mb-3">
//                         <label htmlFor="inputName" className="form-label">Full Name </label><BsAsterisk className="asteriskIcon" />
//                             <input type="text" className="form-control" placeholder="Full Names"
//                             name='names'{...register('names', {required:true})}
//                             />
...
//                         </div>
//                         <div className="mb-3">
//                         <label htmlFor="inputSubject" className="form-label">Subject </label> <BsAsterisk className="asteriskIcon" />
//                             <input type="text" className="form-control" placeholder="Subject" 
//                               name='subject'  {...register('subject', {required:true})}
//                             />
...
//                             <textarea className="form-control" id="exampleFormControlTextarea1" rows="4" placeholder="Write your message here..."
